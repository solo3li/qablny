...
const styles = StyleSheet.create({
  ...
  ageLabel: { fontSize: 15, color: Colors.textSecondary, fontFamily: 'PlusJakartaSans_700Bold' },
  ...
  ageValue: { fontSize: 18, fontFamily: 'PlusJakartaSans_800ExtraBold', color: Colors.primary },
  ...
  agePresetText: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', color: Colors.textMuted },
